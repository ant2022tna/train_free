python main_sc2.py \
    --mode agent \
    --domain medical \
    --experiment_name eval200_MP_health800_200_ds_sc_1_tt_all_scref2-pel_step5 \
    --dataset MP_health \
    ...
    #/home/ubuntu/yuhang2/youtu-agent/training_free_grpo/data/medical/train/MP_health100_ds_sc_1_tt_conf5_scref2-pel_all/step_4/experiences.json

#    

# /home/ubuntu/yuhang2/youtu-agent/training_free_grpo/data/medical/train/MP_health100_ds_sc_1_tt_ds_all_40exp/step_3/experiences.json
